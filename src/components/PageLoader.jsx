...
const PageLoader = () => {
  ...
  return (
<section className='bg-[#F5F5F5] h-[100vh] flex justify-center items-center'>
<div className="text-center max-w-[20em] w-[100%] flex items-center justify-center">
	<svg className="block w-[5em] h-[5em]" role="img" aria-label="Shopping cart line animation" viewBox="0 0 128 128" width="128px" height="128px" xmlns="http://www.w3.org/2000/svg">
